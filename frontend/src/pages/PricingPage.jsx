...
export default function PricingPage() {
  ...
  const handleSubscribe = async (tier) => {
    ...
    try {
      const priceId = tier.priceId?.[selectedFrequency.key];
      if (priceId) {
  ...
  return (
    <div className="relative flex max-w-4xl flex-col items-center py-24 mx-auto px-4">
      ...
      <div className="flex max-w-xl flex-col text-center">
        ...
        <h1 className="text-4xl font-medium tracking-tight">Fact-check any video.</h1>
        <Spacer y={4} />
        <h2 className="text-large text-default-500">
          AI-powered video analysis starting at less than $4/month.
        </h2>
      </div>
      <Spacer y={8} />
      <Tabs
          ...
          >
            ...
            <CardBody className="gap-8">
              <p className="flex items-baseline gap-1 pt-2">
                <span className="from-foreground to-foreground-600 inline bg-gradient-to-br bg-clip-text text-4xl leading-7 font-semibold tracking-tight text-transparent">
      ...
      <div className="flex py-2">
        <p className="text-default-400">
          Questions?&nbsp;
          <Link color="foreground" href="mailto:support@truthlens.app" underline="always">
            Contact us
          </Link>
        </p>
      </div>
